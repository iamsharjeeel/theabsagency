    ...
    <form onSubmit={onSubmit} noValidate className="space-y-5" aria-live="polite">
        ...
        {fields.map((field) => (
          <div key={field.key} className="space-y-2">
            ...
            <Input
              ...
              className="h-11 rounded-sm border-outline-variant bg-surface-lowest font-light"
            />
            {errors[field.key] && (
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          className="rounded-sm border-outline-variant bg-surface-lowest font-light"
        />
        {errors.message && (
      ...
      <button
        ...
        className={cn(
          "inline-flex w-full items-center justify-center bg-cta px-7 py-3.5 text-[0.7rem] tracking-[0.18em] text-on-cta uppercase transition-all duration-300 hover:scale-[1.01] hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-60 sm:w-auto"
        )}
      >
